...
function (e) {
    function t(t, n) {
		...
		function (t) {
		    function o() {
		        ...
		        var r = e.selection;
		        "bullist" == a && r.selectorChanged("ul > li", n("UL")),
				"numlist" == a && r.selectorChanged("ol > li", n("OL")),
				t.settings.stateSelector && r.selectorChanged(t.settings.stateSelector,
				function (e) {
				    t.active(e)
				},
				!0),
				t.settings.disabledStateSelector && r.selectorChanged(t.settings.disabledStateSelector,
				function (e) {
				    t.disabled(e)
				})
		    }
    ...
    function n(e) {
        ...
        return r.length || d.toolbar === !1 || n(d.toolbar || y),
		r.length ? {
		    type: "panel",
		    layout: "stack",
		    classes: "toolbar-grp",
    ...
    function r() {
        ...
        var r, i = [],
		o = [];
        if (d.menu) for (r in d.menu) o.push(r);
        else for (r in v) o.push(r);
    ...
    function i(t) {
        ...
        e.shortcuts.add("Alt+F9", "",
		function () {
		    n("menubar")
		}),
		e.shortcuts.add("Alt+F10", "",
		function () {
		    n("toolbar")
		}),
		e.shortcuts.add("Alt+F11", "",
		function () {
		    n("elementpath")
		}),
		t.on("cancel",
    ...
    function o(t, n) {
		...
		a = r(i),
		s = r(o),
		null !== t && (t = Math.max(d.min_width || 100, t), t = Math.min(d.max_width || 65535, t), m.setStyle(i, "width", t + (a.width - s.width)), m.setStyle(o, "width", t)),
		n = Math.max(d.min_height || 100, n),
		n = Math.min(d.max_height || 65535, n),
		m.setStyle(o, "height", n),
		e.fire("ResizeEditor")
    }
    function a(t, n) {
    ...
    function s() {
        ...
        function r(t) {
            var n, r, i;
            return n = tinymce.DOM.getPos(e.getContentAreaContainer()),
			r = e.dom.getRect(t),
			i = e.dom.getRoot(),
			"BODY" == i.nodeName && (r.x -= i.ownerDocument.documentElement.scrollLeft || i.scrollLeft, r.y -= i.ownerDocument.documentElement.scrollTop || i.scrollTop),
			r.x += n.x,
			r.y += n.y,
			r
        }
        ...
        function o(t) {
            ...
            if (!e.removed) {
                ...
                u = ["tc-bc", "bc-tc", "tl-bl", "bl-tl", "tr-br", "br-tr"],
				l = t.toolbar.panel,
				l.show(),
				a = r(t.element),
				o = tinymce.DOM.getRect(l.getEl()),
				s = tinymce.DOM.getRect(e.getContentAreaContainer() || e.getBody()),
				a.w = t.element.clientWidth,
				a.h = t.element.clientHeight,
				e.inline || (s.w = e.getDoc().documentElement.offsetWidth),
				e.selection.controlSelection.isResizable(t.element) && (a = p.inflate(a, 0, 8)),
				n = p.findBestRelativePosition(o, a, s, u),
				n ? (h(u.concat("inside"),
				function (e) {
				    l.classes.toggle("tinymce-inline-" + e, e == n)
				}), c = p.relativePosition(o, a, n), l.moveTo(c.x, c.y)) : (h(u,
				function (e) {
        ...
        function s() {
            d || (d = e.selection.getScrollContainer() || e.getWin(), tinymce.$(d).on("scroll", a), e.on("remove",
			function () {
        ...
        function u(t) {
            var r, i, o, a = n();
            for (o = e.$(t).parents().add(t), r = o.length - 1; r >= 0; r--) for (i = a.length - 1; i >= 0; i--) if (a[i].predicate(o[r])) return {
                toolbar: a[i],
                element: o[r]
            };
            return null
        ...
        var d;
        e.on("click keyup setContent",
		function (t) {
		    ("setcontent" != t.type || t.selection) && tinymce.util.Delay.setEditorTimeout(e,
                function () {
                    var t;
                    t = u(e.selection.getNode()),
                    t ? (c(), l(t)) : c()
                })
		}),
		e.on("blur hide", c),
		...
		e.on("nodeChange ResizeEditor ResizeWindow", a),
		e.on("remove",
		function () {
		    tinymce.each(n(),
			function (e) {
    ...
    function l(t) {
        function o() {
            if (h && h.moveRel && h.visible() && !h._fixed) {
                ...
                if (t) {
                    var o = m.getPos(n),
					a = m.getPos(t);
                    r = Math.max(0, a.x - o.x),
					i = Math.max(0, a.y - o.y)
                }
        ...
        var h, p;
        return d.fixed_toolbar_container && (p = m.select(d.fixed_toolbar_container)[0]),
		d.content_editable = !0,
		e.on("focus",
		function () {
    ...
    function c(t) {
        ...
        var l, c, h;
        return t.skinUiCss && tinymce.DOM.loadCSS(t.skinUiCss),
		l = u.panel = f.create({
		    type: "panel",
		    role: "application",
		    classes: "tinymce",
		...
		d.readonly && l.find("*").disabled(!0),
		e.fire("BeforeRenderUI"),
		e.on("SwitchMode", a()),
		l.renderBefore(t.targetNode).reflow(),
		d.width && tinymce.DOM.setStyle(l.getEl(), "width", d.width),
		e.on("remove",
		function () {
		    l.remove(),
			l = null
    ...
    u.renderUI = function (t) {
        ...
        if (n) {
            var r = d.skin_url;
            r = r ? e.documentBaseURI.toAbsolute(r) : tinymce.baseURL + "/skins/" + n,
			tinymce.Env.documentMode <= 7 ? t.skinUiCss = r + "/skin.ie7.min.css" : t.skinUiCss = r + "/skin.min.css",
			e.contentCSS.push(r + "/content" + (e.inline ? ".inline" : "") + ".min.css")
        }
        return e.on("ProgressState",
		function (e) {
		    u.throbber = u.throbber || new tinymce.ui.Throbber(u.panel.getEl("body")),
			e.state ? u.throbber.show(e.time) : u.throbber.hide()
		}),
		d.inline ? l(t) : c(t)
    },
	u.resizeTo = o,
